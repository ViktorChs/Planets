...
function Technology (){
    ...
    const techData = {
        ...
        Spaceport: {
            ...
            img: "/src/technology/image-spaceport-portrait.jpg",
            img2:"/src/technology/image-spaceport-landscape.jpg"
        },
        Vehicle: {
            ...
            img2:"/src/technology/image-launch-vehicle-landscape.jpg"
        }
      }
      function Appp() {
        const [windowSize, setWindowSize] = useState({
